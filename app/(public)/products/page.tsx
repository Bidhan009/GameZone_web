        ...
        <div className="min-h-screen bg-[#0f1218]">
            ...
            <div className="bg-[#1a1f29] border-b border-gray-800 py-6">
                <div className="container mx-auto px-4">
                    <h1 className="text-2xl font-black text-white uppercase tracking-wide">All Products</h1>
                    <p className="text-gray-500 text-sm mt-1">Browse our collection of gaming products</p>
                </div>
            </div>
